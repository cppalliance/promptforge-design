...
- PromptForge core-library design - `promptforge-design/design/design-core.md`: the `Executor`, `register_capability`, `Surfaces`, the canonical vocabulary, the `ask_user` stub, and the one-way `Observer`.
